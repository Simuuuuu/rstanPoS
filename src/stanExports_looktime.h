...
namespace model_looktime_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_looktime");
    reader.add_event(25, 23, "end", "model_looktime");
    return reader;
}
#include <stan_meta_header.hpp>
class model_looktime
  : public stan::model::model_base_crtp<model_looktime> {
private:
        int m1;
        int n1event;
        double mu;
        ...
        vector_d z_looktime;
public:
    model_looktime(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_looktime_namespace::model_looktime";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "n1event", "int", context__.to_vec());
            n1event = int(0);
            vals_i__ = context__.vals_i("n1event");
            pos__ = 0;
            n1event = vals_i__[pos__++];
            check_greater_or_equal(function__, "n1event", n1event, 0);
            ...
            validate_non_negative_index("y_looktime", "n1event", n1event);
            context__.validate_dims("data initialization", "y_looktime", "vector_d", context__.to_vec(n1event));
            y_looktime = Eigen::Matrix<double, Eigen::Dynamic, 1>(n1event);
            vals_r__ = context__.vals_r("y_looktime");
            pos__ = 0;
            size_t y_looktime_j_1_max__ = n1event;
            for (size_t j_1__ = 0; j_1__ < y_looktime_j_1_max__; ++j_1__) {
                y_looktime(j_1__) = vals_r__[pos__++];
            }
            current_statement_begin__ = 9;
            validate_non_negative_index("z_looktime", "m1", m1);
            context__.validate_dims("data initialization", "z_looktime", "vector_d", context__.to_vec(m1));
            z_looktime = Eigen::Matrix<double, Eigen::Dynamic, 1>(m1);
            vals_r__ = context__.vals_r("z_looktime");
            pos__ = 0;
            size_t z_looktime_j_1_max__ = m1;
            for (size_t j_1__ = 0; j_1__ < z_looktime_j_1_max__; ++j_1__) {
                z_looktime(j_1__) = vals_r__[pos__++];
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            lp_accum__.add(weibull_log(y_looktime, kappa, theta));
            current_statement_begin__ = 19;
            lp_accum__.add(weibull_ccdf_log(z_looktime, kappa, theta));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_looktime_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_looktime_namespace::model_looktime stan_model;
#ifndef USING_R
